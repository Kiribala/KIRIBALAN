...
Polished version: improved color contrast for better readability.
Keeps backend API URL and logic unchanged.
"""
...
# ---- Glass theme CSS with improved text contrast ----
st.markdown(
    """
    <style>
    :root{
      /* Brighter glass palette for high contrast */
      --glass-bg: rgba(255,255,255,0.08);
      --glass-border: rgba(255,255,255,0.22);
      --accent: #3aa3ff; /* bright blue accent */
      --accent-strong: #1f78d1; /* deeper for buttons */
      --text-primary: #eaf6ff; /* very light for main text */
      --text-muted: rgba(234,246,255,0.78); /* readable muted text */
      --card-shadow: rgba(5,12,30,0.6);
    }
    body {background: linear-gradient(135deg, #022740 0%, #083048 100%);} /* deep navy */
    ...
    /* Inputs & placeholders: make text white and placeholder lighter */
    input, textarea {
    ...
    ::placeholder { color: rgba(234,246,255,0.55); }

    /* Buttons: accent with clear hover */
    .stButton>button{
      ...
      border-radius:10px;
      padding: 8px 12px;
      box-shadow: 0 6px 18px rgba(15,52,87,0.35);
    }
    .stButton>button:hover{ opacity:0.95 }

    /* Code block styling (commit hash) */
    .stCodeBlock pre {
    ...
    /* Improve Streamlit spacing */
    .css-1d391kg {padding-top: 0.6rem}

    /* Responsive tweaks */
    @media (max-width: 768px){ .glass-card{padding:14px} }
    </style>
    """,
